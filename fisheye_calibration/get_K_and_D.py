...
def get_K_and_D(checkerboard, imgsPath,l):

    CHECKERBOARD = checkerboard
    subpix_criteria = (cv2.TERM_CRITERIA_EPS+cv2.TERM_CRITERIA_MAX_ITER, l, 0.1)
    ...
    rms, _, _, _, _ = cv2.fisheye.calibrate(
        ...
        tvecs,
        calibration_flags,
        (cv2.TERM_CRITERIA_EPS+cv2.TERM_CRITERIA_MAX_ITER, l, 1e-6)
    )
    DIM = _img_shape[::-1]
